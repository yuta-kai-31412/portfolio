...
export const PROJECTS: Project[] = [
  {
    ...
    detailedDescription: "個人設計事務所でのアルバイトに際して、Shapr3Dによるモデルの構築およびMorpholio Trace（モルフォリオ・トレース）によるパース作成の導入提案を行いました。これにより、伝統的な図面修正に伴う二度手間や手戻りの回数を劇的に減少させ、かつ限られた検証期間内にこれまで以上に多くの革新的なアイデアを深く検討することができました。この効率的でクリエイティブなアプローチを用いてデザインされ、実地にて素晴らしいBBQ（バーベキュー）場が竣工を遂げました。",
...
export const INTERESTS = [
  ...
  },
  {
    ...
    icon: "Award",
    title: "合気道",
    detail: "大学四年間で合気道二段を取得しました。腕力で力任せに相手と競い合うのではなく、相手の力と同調して柔らかくいなす姿勢を大切にしています。",
  ...
  },
  {
    ...
    icon: "Compass",
    title: "麻雀",
    detail: "友人と競技レベルでの打ち合いに惹かれています。常に冷静沈着な状況判断力を養い、押し引きなどを見極める高い戦略性を楽しんでいます。",
  ...
  },
  {
    ...
    icon: "ChefHat",
    title: "料理 ＆ ラーメン巡り",
    detail: "独学で魚を捌いたり、お菓子を作ったりします。もちろん食べるのも好きでお気に入りのラーメン屋には通算100回以上行きました。",
