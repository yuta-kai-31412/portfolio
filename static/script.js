  ...
  const PROJECTS = [
    {
      ...
      description:
        '個人設計事務所でのアルバイトに際して、Shapr3Dによるモデルの構築およびMorpholio Traceによるパース作成の導入提案を行いました。これにより、図面修正に伴う模型の二度手間や手戻りの回数を劇的に減少させ、かつ限られた検証期間内にこれまで以上に多くの革新的なアイデアを深く検討することができました。この効率的で創造的なアプローチを用いてデザインされ、実地にて素晴らしいBBQ場が竣工を遂げました。',
    ...
    {
      title: 'GASとスプレッドシートを用いたシフト管理システム',
      subtitle: '個人飲食店向けデジタルシフト管理＆業務プロセスの変革',
      image: 'public/images/project/project03.jpg',
      description:
        'アルバイト先の個人経営の飲食店で、コストがかかることと導入ハードルから手書きでのシフト管理が行われていたが、シフト間違いや出勤しなければシフトを提出できないなどの問題がありました。そこでGoogle spreadsheetのappsscript機能を用いたシフト管理ウェブアプリケーションを開発しました。これによりいつでも誰でも容易に利用できるシフト管理システムを導入できました。またこのほかにも発注票の作成、マニュアルの作成などデジタル技術を用いた業務改善を行いました。',
      duration: '2025年4月 - 現在',
      insights: [
