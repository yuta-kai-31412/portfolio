...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const PROJECTS = [
    ...
    },
    {
      ...
      description:
        'アルバイト先の個人経営の飲食店で、コストがかかることと導入ハードルから手書きでのシフト管理が行われていたが、シフト間違いや出勤しなければシフトを提出できないなどの問題があった。そこでGoogle spreadsheetのappsscript機能を用いたシフト管理ウェブアプリケーションを開発。これによりいつでも誰でも容易に利用できるシフト管理システムを導入できました。またこのほかにも発注票の作成、マニュアルの作成などデジタル技術を用いた業務改善を行いました。',
      duration: '2025年4月 - 現在',
      insights: [
